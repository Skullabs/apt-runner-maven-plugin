...
public class ClassFileReader {
	...
	public ClassFileReader( File targetDir ) {
	...
	private static StringJavaSource readFileAndRemove( String canonicalName, File decompiledFile ) {
		try {
			final byte[] bytes = Files.readAllBytes( Paths.get( decompiledFile.getAbsolutePath() ) );
			if ( !decompiledFile.delete() )
